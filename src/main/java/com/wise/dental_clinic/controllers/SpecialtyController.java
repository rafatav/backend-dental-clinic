...
public class SpecialtyController {
    ...
    @GetMapping
    public ResponseEntity<Page<SpecialtyDTO>> findAll(@RequestParam(value = "name", required = false) String name, Pageable pageable) {
        Page<SpecialtyDTO> dto = service.findAll(name, pageable);
