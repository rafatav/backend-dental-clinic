...
public class DentistController {
    ...
    @PostMapping
    public ResponseEntity<DentistDTO> insert(@RequestBody DentistDTO dto) {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<DentistDTO> update(@RequestBody DentistDTO dto, @PathVariable Long id) {
